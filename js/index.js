...
const SuccessMessageBox = () => {
    return div({
        ...
        style: `
                ...
                margin-top: 14px;
            `,
    }, svg({ xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 1024 1024", width: "1em", height: "1em" }, path({ fill: "#67C23A", "d": "M512 64a448 448 0 1 1 0 896 448 448 0 0 1 0-896m-55.808 536.384-99.52-99.584a38.4 38.4 0 1 0-54.336 54.336l126.72 126.72a38.272 38.272 0 0 0 54.336 0l262.4-262.464a38.4 38.4 0 1 0-54.272-54.336z" }))), '著作权人信息复制成功');
};
const all_style = `
    .success_message_box {
        position: fixed;
...
`;
(function () {
    van.add(document.body, style(all_style), SuccessMessageBox(), FixedBtn(), GetBtn());
    ...
    if (hoverBtn) {
        hoverBtn.addEventListener('click', () => {
            ...
            const userList = [...document.querySelectorAll('.titleTxt')].map(x => x.textContent).filter(x => x);
            const SuccessMessageBox = document.querySelector('.success_message_box');
            if (userList.length === 0)
                return;
            if (!flowCodeBox || !r11NameBox)
                return;
            let r11Info = {
